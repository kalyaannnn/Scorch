...
extern "C"{
    ...
    Tensor* sum_tensor(Tensor* tensor1, Tensor* tensor2, bool keepdim);
    Tensor* max_tensor(Tensor* tensor1, Tensor* tensor2, bool keepdim);
    Tensor* min_tensor(Tensor* tensor1, Tensor* tensor2, bool keepdim);
    Tensor* sub_tensor(Tensor* tensor1, Tensor* tensor2, bool keepdim);
    Tensor* elementwise_mul_tensor(Tensor* tensor1, Tensor* tensor2);
    Tensor* scalar_mul_tensor(Tensor* tensor1, float scalar);
    Tensor* scalar_div_tensor(Tensor* tensor1, float scalar);
